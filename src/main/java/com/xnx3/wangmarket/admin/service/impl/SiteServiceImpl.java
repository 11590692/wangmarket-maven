...
//					carousel.setImage(AttachmentFile.netUrl()+"res/default_carousel/car_1.jpg");
					...
					if(site.getClient() == Site.CLIENT_PC){
						...
						newsSiteColumn.setIcon(G.RES_CDN_DOMAIN+"default_image/new.png");
						...
						xwNews.setTitlepic(G.RES_CDN_DOMAIN+"image/huanqing.png");
						...
						imageSiteColumn.setIcon(G.RES_CDN_DOMAIN+"default_image/project.png");
						...
						productNews.setTitlepic(G.RES_CDN_DOMAIN+"image/huanqing.png");
						...
						lxSC.setIcon(G.RES_CDN_DOMAIN+"default_image/lianxi.jpeg");
						lxSC.setName("联系我们");
						lxSC.setParentid(0);
						lxSC.setRank(4);
