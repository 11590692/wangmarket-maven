/*设置底部的网站相关信息*/
if(document.getElementById('footerCopyRight') != null){
...
function initFooterSiteColumnData() {
	...
	if (siteColumnRank.langth != siteColumn.length) {
		...
		if(document.getElementById('footerColumnList') != null){
...
/*2016.10.9升级*/
try{
	document.getElementById('qrImg').innerHTML='<img id="qrImage" src="'+resBasePath+'image/loading.svg" alt="二维码"><div id="footerQrImage">微&nbsp;信&nbsp;扫&nbsp;一&nbsp;扫</div>';
